...
Ext.define('ExPlugins.textwindow.TextWindow', {
    ...
    getCodemirrorPath: function (){
        return 'arn/Codemirror/codemirror-'+(arn ? arn.nav.versions['codemirror'] : "5.50.0")+'/';
    },
    getRequire: function (){
    ...
    initCodeMirror: function(mode){
        ...
        // me.getRequire()(['codemirror'], function (cm) {
        //     window.CodeMirror = cm;
            me.getRequire()([
                ...
                if(!me.codeMirror) {
                    ...
                    if(!me.codeMirror.showHint)  Ext.toast("提示控件异常！请刷新页面重试！");

                    if(me.codeMirror.showHint)  Ext.toast("提示控件加载完成，按键即可呼出。");
                    ...
                    me.codeMirror.on("keypress", function (thiz, e) {
                        ...
                        // 调用显示提示
                        if(!me.codeMirror.showHint) return;
