        ...
        function() {
            ...
            let nav = window.navigator,
                ...
                generatePDFJSMarkup = function(targetNode, url, pdfOpenFragment, PDFJS_URL, id, omitInlineStyles) {
                    ...
                    return iframe.src = fullURL,
                        iframe.className = "pdfobject",
                        iframe.type = "application/pdf",
                        iframe.frameborder = "0",
                    id && (iframe.id = id),
                    omitInlineStyles || (div.style.cssText = "position: absolute; top: 0; right: 0; bottom: 0; left: 0;", iframe.style.cssText = "border: none; width: 100%; height: 100%;", targetNode.style.position = "relative", targetNode.style.overflow = "auto"),
                    ...
                    if (supportsPDFs || assumptionMode && isModernBrowser && !isMobileDevice) {
                        return function(embedType, targetNode, targetSelector, url, pdfOpenFragment, width, height, id, omitInlineStyles) {
                            ...
                            if (embed.src = url + pdfOpenFragment, embed.className = "pdfobject", embed.type = "application/pdf", id && (embed.id = id), !omitInlineStyles) {
                                ...
                                targetSelector && targetSelector !== document.body ? style += "width: " + width + "; height: " + height + ";": style += "position: absolute; top: 0; right: 0; bottom: 0; left: 0; width: 100%; height: 100%;",
