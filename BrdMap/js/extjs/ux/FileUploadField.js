	...
	bindListeners	: function() {
		this.fileInput.on({
			...
			change		: function() {
				...
				if (Ext.isIE8) {
					/*
					 * 修改人：杨帆 添加以下代码为在IE8下展现真实路径
					 */
					var file_upl = document.getElementById(this.getFileInputId());
					file_upl.select();
					v = document.selection.createRange().text;
				} else {
					// var v = this.fileInput.dom.value;
					// 源代码，这样在IE8下是c:\fakepath表示的路径
...
Ext.preg('fileuploadfield', Ext.ux.form.FileUploadField);
