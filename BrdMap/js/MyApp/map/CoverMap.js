        ...
        },
        {
            ...
            LoadKpi: function (src, legend, opertype)
            {
                ...
                else
                {
                    ...
                    if (!Ext.isEmpty(this.cur_legend) && !Ext.isEmpty(this.cur_legend.field) && this.cur_legend.field.toLowerCase().indexOf("vip") > -1)
                    {
                        ...
                        // 获取投诉数据
                        this.Request(APPBASE + '/lib/BrdMap/js/MyApp/map/complaintvips.js', undefined, function (r, e) { this.data = r; this.Invalidate(); });
                    }
                    else
                    {
                        ...
                        this.tile.SetViewCenter(pt.x, pt.y, 11);
                        // 获取投诉数据
                        this.Request(APPBASE + '/lib/BrdMap/js/MyApp/map/complaints.js', undefined, function (r, e) { this.data = r; this.Invalidate(); });
                    }
            ...
            OnInitUpdate: function ()
            {
                ...
                if (this.Visible)
                {
                    ...
                    //this.Load(APPBASE + '/lib/BrdMap/js/MyApp/map/areagrids.js');
            ...
            OnViewportChanged: function (bFinally, tile)
            {
                ...
                if (bFinally && this.Visible)
                {
                    ...
                    if (!Ext.isEmpty(this.cur_legend))
                    {
                        ...
                        //this.LoadAreagridKPI(APPBASE + '/lib/BrdMap/js/MyApp/map/areagridkpis.js',);
                    }
                    else
                        this.Invalidate();
                }
            ...
            {
                this.callParent(arguments);
                this.Load(APPBASE + '/lib/BrdMap/js/MyApp/map/surfaces.js');
            },
            OnViewportChanged: function (bFinally, tile)
            {
                if (bFinally)
            ...
            OnInitUpdate: function ()
            {
                ...
                if (this.Visible)
                {
                    this.OnViewportChanged(true, this.map.tile);
                    //var vb = this.map.getViewBoundLngLat();
                    //this.Load(APPBASE + '/lib/BrdMap/js/MyApp/map/cells.js');
            ...
            OnViewportChanged: function (bFinally, tile)
            {
                ...
                if (bFinally && this.Visible)
                {
                    ...
                    if (!Ext.isEmpty(this.cur_legend))
                    {
                        ...
                        //this.LoadSectorKPI(APPBASE + '/lib/BrdMap/js/MyApp/map/cellkpis.js');
                    }
                }
                else
                    this.Invalidate();
