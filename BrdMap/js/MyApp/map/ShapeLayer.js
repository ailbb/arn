...
Ext.define('MyApp.map.ShapeLayer', {
    ...
    Load: function ()
    {
        ...
        if (b)
        {
            this.Request(APPBASE + '/lib/BrdMap/js/MyApp/map/grids.js', undefined, function (r, e) { this.data = r; this.Invalidate(); });
        }
        else if (this.shape == 5)
        {
            this.Request(APPBASE + '/lib/BrdMap/js/MyApp/map/areagrids.js', undefined, function (r, e) { this.data = r; this.Invalidate(); });
        }
    },
    OnDraw: function (ctx)
    {
